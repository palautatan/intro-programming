...
class food:
    ...
    def calculateCalories(self, output=True):
        '''
    ...
    def calculateServingGrams(self, output=True):
...
class daily_log:
    ...
    def calorieCount(self):
        ...
        daily_cals = []
        for ix in range(len(self.food)):
            daily_cals.append(self.food[ix].total_cals * self.num_servings[ix])
